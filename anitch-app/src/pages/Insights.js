  ...
  if(entries.length<3)return(
    <div style={s.page}>
      <div style={s.header}>
        ...
        <div style={s.sub}>{t.insights.sub}</div>
      </div>
      <div style={s.body}>
      ...
      <div style={s.body}>
        ...
        <div style={s.card}>
          ...
          <div style={s.chartLegend}>
            ...
            <span style={{fontSize:'10px',color:theme.textMuted,marginRight:'12px'}}>Low</span>
            <span style={{display:'inline-block',width:'8px',height:'8px',borderRadius:'2px',background:theme.orange,marginRight:'4px'}}/>
            <span style={{fontSize:'10px',color:theme.textMuted}}>Flare</span>
          </div>
        </div>
        ...
        <button style={s.exportBtn} onClick={()=>alert('PDF export — coming soon!\nPDF匯出功能即將推出！')}>
          {t.insights.export}
        </button>
      </div>
    </div>
