  ...
  return (
    <div style={{ background: th.lightGrey, minHeight: '100vh', fontFamily: "'Lato',sans-serif", paddingBottom: '100px' }}>
      ...
      <div style={{ padding: '14px 14px 0' }}>
        ...
        {/* Log button */}
        <button style={{ width: '100%', color: 'white', border: 'none', borderRadius: '8px', padding: '16px', fontSize: '14px', fontWeight: '700', cursor: 'pointer', letterSpacing: '0.04em', marginBottom: '10px', background: todayLogged ? th.greenMid : th.green }}
